package ru.razbejkin.queue.security;
...
import ru.razbejkin.queue.security.filter.CustomAuthenticationFilter;
import ru.razbejkin.queue.security.filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(POST,"/api/persons").permitAll();
        http.authorizeRequests().antMatchers(GET,"/api/tickets/free").permitAll();
